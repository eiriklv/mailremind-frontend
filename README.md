...
[![Dependency Status](https://david-dm.org/eiriklv/mailremind-frontend.svg)](https://david-dm.org/eiriklv/mailremind-frontend)
[![devDependency Status](https://david-dm.org/eiriklv/mailremind-frontend/dev-status.svg)](https://david-dm.org/eiriklv/mailremind-frontend#info=devDependencies)

#### Introduction:
Scheduled e-mail reminders. Check it out at [mailremind.me](http://mailremind.me/)

![express passport application](http://s29.postimg.org/6zbwl1fnb/preview.png "Mailremind.me")
...
#### Create an application on both Facebook and Google+ and point the callbacks to (respectively):
...
export MONGO_URL="mongodb://localhost/mailremind" \
...
export MANDRILL_SENDER="Express Passport Application <noreply@mailremind.me>" \
